...
{
 public:
  ~NFmiWeatherAndCloudiness() override;
  ...
  NFmiCombinedParam* Clone() const override;
  ...
  unsigned long LongValue() const override;
 ...
 protected:
  ...
  void CreateIntegrators() override;
